...
template<::SoLib::IsContainer C>
uint32_t SoLib::ImGuiDebug::ImGuiWidget(const char *const label, C *const value, const uint32_t index, const ::std::function<::std::string(uint32_t)> &displayChar) {
...
Itr SoLib::ImGuiDebug::ImGuiWidget(const char *const label, C *const value, Itr itr, const Func &displayChar) {
