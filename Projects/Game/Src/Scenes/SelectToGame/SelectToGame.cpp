...
SelectToGame::SelectToGame() {
	...
	stageItemTextureIDs[2] = texManager->LoadTexture("./Resources/UI/Item/orb.png"); // オーブ
	...
	stageItemTextureIDs[5] = texManager->LoadTexture("./Resources/UI/Item/sord.png"); // 剣
	stageItemTextureIDs[6] = texManager->LoadTexture("./Resources/UI/Item/elixir.png"); // エリクサー
	stageItemTextureIDs[7] = texManager->LoadTexture("./Resources/UI/Item/human.png");   // おっさん
