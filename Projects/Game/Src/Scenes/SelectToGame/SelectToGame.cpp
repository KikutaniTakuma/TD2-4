...
SelectToGame::SelectToGame() {
	...
	stageItemTextureIDs[0] = texManager->LoadTexture("./Resources/UI/Item/gold.png"); // ゴールド
	stageItemTextureIDs[1] = texManager->LoadTexture("./Resources/UI/Item/pendant.png"); // ペンダント
	stageItemTextureIDs[2] = texManager->LoadTexture("./Resources/UI/product.png"); // 未定
	...
	stageItemTextureIDs[5] = texManager->LoadTexture("./Resources/UI/Item/orb.png"); // オーブ
	stageItemTextureIDs[6] = texManager->LoadTexture("./Resources/UI/Item/sord.png"); // 剣
	stageItemTextureIDs[7] = texManager->LoadTexture("./Resources/UI/product.png");   // 未定
